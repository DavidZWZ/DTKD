...
class ContextRecommender(AbstractRecommender):
    ...
    def embed_token_seq_fields(self, token_seq_fields, mode='mean'):
        ...
        for i, token_seq_field in enumerate(token_seq_fields):
            if token_seq_field.size(1) != 384:
                ...
                result = token_seq_field.unsqueeze(1)
    ...
    def embed_input_fields(self, interaction):
        ...
        token_seq_fields = []
        token_seq_bert_fields_embedding = None
        ...
        if token_fields_embedding is None:
            ...
            if token_seq_fields_embedding is None:
                ...
                if token_seq_bert_fields_embedding is None:
                    sparse_embedding = torch.cat([token_seq_fields_embedding, token_fields_embedding], dim=1)
                else:
                    sparse_embedding = torch.cat([token_seq_fields_embedding, token_fields_embedding, token_seq_bert_fields_embedding], dim=1)
